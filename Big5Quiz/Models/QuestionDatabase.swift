...
struct QuestionDatabase{
    ...
    //Activity COMPLETE
        ...
        Question(content: "I like to take it easy", trait: Trait.Extraversion, Subtrait: Subtrait.Activity, positiveQuestion: false),
         Question(content: "I let things happen at their own pace", trait: Trait.Extraversion, Subtrait: Subtrait.Activity, positiveQuestion: false),
        Question(content: "I react slowly", trait: Trait.Extraversion, Subtrait: Subtrait.Activity, positiveQuestion: false)],
    //Cheerfulness COMPLETE
    ...
    //Gregariousness COMPLETE
        ...
        Question(content: "I love large parties", trait: Trait.Extraversion, Subtrait: Subtrait.Gregariouness, positiveQuestion: true),
         Question(content: "I feel insecure when talking to new people", trait: Trait.Extraversion, Subtrait: Subtrait.Gregariouness, positiveQuestion: false),
    ...
    //Assertiveness COMPLETE
        ...
        Question(content: "I try to lead others", trait: Trait.Extraversion, Subtrait: Subtrait.Assertiveness, positiveQuestion: true),
         Question(content: "When I say no to someone it makes me afraid or anxious", trait: Trait.Extraversion, Subtrait: Subtrait.Assertiveness, positiveQuestion: false),
         Question(content: "I always ask when I dont understand something", trait: Trait.Extraversion, Subtrait: Subtrait.Assertiveness, positiveQuestion: true),
         Question(content: "I maintain eye contact when have a discussion", trait: Trait.Extraversion, Subtrait: Subtrait.Assertiveness, positiveQuestion: true),
         Question(content: "I feel guilty of something even when its not necessarily my fault it went wrong", trait: Trait.Extraversion, Subtrait: Subtrait.Assertiveness, positiveQuestion: false),
    ...
    //Friendliness COMPLETE
        ...
        Question(content: "I keep others at a distance", trait: Trait.Extraversion, Subtrait: Subtrait.Friendliness, positiveQuestion: false),
         Question(content: "I meeting new people", trait: Trait.Extraversion, Subtrait: Subtrait.Friendliness, positiveQuestion: true),
         Question(content: "I keep others at a distance", trait: Trait.Extraversion, Subtrait: Subtrait.Friendliness, positiveQuestion: false),
        Question(content: "I avoid crowds", trait: Trait.Extraversion, Subtrait: Subtrait.Friendliness, positiveQuestion: false)],
    //Excitement Seeking COMPLETE
        ...
        Question(content: "I enjoy wild fights of fantasy", trait: Trait.Extraversion, Subtrait: Subtrait.Excitement_Seeking, positiveQuestion: true),
         Question(content: "I rather have a new experience than to revisit previous experiences", trait: Trait.Extraversion, Subtrait: Subtrait.Excitement_Seeking, positiveQuestion: true),
        Question(content: "I love excitement", trait: Trait.Extraversion, Subtrait: Subtrait.Excitement_Seeking, positiveQuestion: true),
         Question(content: "I get bored easily if im not doing something that I partuicularly enjoy", trait: Trait.Extraversion, Subtrait: Subtrait.Excitement_Seeking, positiveQuestion: true),
         Question(content: "I avoid daily routine", trait: Trait.Extraversion, Subtrait: Subtrait.Excitement_Seeking, positiveQuestion: true),
         Question(content: "I enjoy spontaneous plans", trait: Trait.Extraversion, Subtrait: Subtrait.Excitement_Seeking, positiveQuestion: true),
    ...
    //Cooperation COMPLETE
        ...
        Question(content: "I obstruct other's plans", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: false),
         Question(content: "I like to share", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: true),
         Question(content: "I prefer to work in group", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: true),
         Question(content: "I am more interested in mutual benefit than having advantage over others", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: true),
         Question(content: "I would rather avoid a discussion if it helps me get along with someone", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: true),
         Question(content: "I go out of my way to get along with others", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: true),
         Question(content: "I try to help when someone is performing a complex task", trait: Trait.Agreeableness, Subtrait: Subtrait.Cooperation, positiveQuestion: true),
    ...
    //Morality COMPLETE
        ...
        Question(content: "I try to follow the rules", trait: Trait.Agreeableness, Subtrait: Subtrait.Morality, positiveQuestion: true),
         Question(content: "Im interested in meeting new people due to second intentions", trait: Trait.Agreeableness, Subtrait: Subtrait.Morality, positiveQuestion: true),
    ...
    //Sympathy COMPLETE
        ...
        Question(content: "I make people feel uncomfortable", trait: Trait.Agreeableness, Subtrait: Subtrait.Sympathy, positiveQuestion: false),
         Question(content: "I easily open up to others", trait: Trait.Agreeableness, Subtrait: Subtrait.Sympathy, positiveQuestion: true),
         Question(content: "I quickly warm up to others", trait: Trait.Agreeableness, Subtrait: Subtrait.Sympathy, positiveQuestion: true),
    ...
    //Altruism COMPLETE
        ...
        Question(content: "I anticipate the needs of others", trait: Trait.Agreeableness, Subtrait: Subtrait.Altruism, positiveQuestion: true),
         Question(content: "I make sacrifices to help others if needed", trait: Trait.Agreeableness, Subtrait: Subtrait.Altruism, positiveQuestion: true),
    ...
    //Trust COMPLETE
        ...
        Question(content: "I trust what people say", trait: Trait.Agreeableness, Subtrait: Subtrait.Trust, positiveQuestion: true),
         Question(content: "I trust in someone's else reliability", trait: Trait.Agreeableness, Subtrait: Subtrait.Trust, positiveQuestion: true),
         Question(content: "I believe you can completely know someone", trait: Trait.Agreeableness, Subtrait: Subtrait.Trust, positiveQuestion: true),
         Question(content: "I trust in what im told", trait: Trait.Agreeableness, Subtrait: Subtrait.Trust, positiveQuestion: true),
    ...
    //Self Efficacy COMPLETE
        [Question(content: "I carry out my plans", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Efficacy, positiveQuestion: true),
        ...
        Question(content: "I have little to contribute", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Efficacy, positiveQuestion: false),
    ...
    //Dutifulness COMPLETE
        ...
        Question(content: "I do the opposite of what im asked", trait: Trait.Conscientiousness, Subtrait: Subtrait.Dutifulness, positiveQuestion: false),
         Question(content: "I respect moral obligations", trait: Trait.Conscientiousness, Subtrait: Subtrait.Dutifulness, positiveQuestion: true),
         Question(content: "I am consistent with my values even in situations where they might not be convenient", trait: Trait.Conscientiousness, Subtrait: Subtrait.Dutifulness, positiveQuestion: true),
         Question(content: "I respect moral obligations", trait: Trait.Conscientiousness, Subtrait: Subtrait.Dutifulness, positiveQuestion: true),
         Question(content: "I am an independent indivual", trait: Trait.Conscientiousness, Subtrait: Subtrait.Dutifulness, positiveQuestion: true),
        Question(content: "I tell the truth", trait: Trait.Conscientiousness, Subtrait: Subtrait.Dutifulness, positiveQuestion: true)],
    //Cautiouness COMPLETE
    ...
    //Self-Discipline COMPLETE
        ...
        Question(content: "I get chores done right away", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Discipline, positiveQuestion: true),
         Question(content: "When I get distracted my immediate thought is to get back to my work", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Discipline, positiveQuestion: true),
         Question(content: "I get chores done right away", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Discipline, positiveQuestion: true),
         Question(content: "I can get through repetitive/boring tasks easily", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Discipline, positiveQuestion: true),
    ...
    //Achievement Striving COMPLETE
        ...
        Question(content: "I work hard", trait: Trait.Conscientiousness, Subtrait: Subtrait.Achievement_Striving, positiveQuestion: true),
         Question(content: "I enjoy trying challenges to improove myself", trait: Trait.Conscientiousness, Subtrait: Subtrait.Achievement_Striving, positiveQuestion: true),
         Question(content: "I make sacrifices needed to achieve my goals", trait: Trait.Conscientiousness, Subtrait: Subtrait.Achievement_Striving, positiveQuestion: true),
         Question(content: "I adapt easily to new situations", trait: Trait.Conscientiousness, Subtrait: Subtrait.Achievement_Striving, positiveQuestion: true),
    ...
    //Anger COMPLETE
        ...
        Question(content: "I rarely get irritaded", trait: Trait.Neuroticism, Subtrait: Subtrait.Anger, positiveQuestion: false),
         Question(content: "I feel calm even in tense situations", trait: Trait.Neuroticism, Subtrait: Subtrait.Anger, positiveQuestion: false),
    ...
    //Vulnerability COMPLETE
        ...
        Question(content: "I am not bothered by difficult social situations", trait: Trait.Neuroticism, Subtrait: Subtrait.Vulnerability, positiveQuestion: false),
         Question(content: "I cant stand confrontations", trait: Trait.Neuroticism, Subtrait: Subtrait.Vulnerability, positiveQuestion: true),
    ...
    //Anxiety COMPLETE
        ...
        Question(content: "I dont worry about things that have already happened", trait: Trait.Neuroticism, Subtrait: Subtrait.Anxiety, positiveQuestion: false),
         Question(content: "I act comfortably around others", trait: Trait.Neuroticism, Subtrait: Subtrait.Anxiety, positiveQuestion: false),
        Question(content: "I focus on my problems more than anything else", trait: Trait.Neuroticism, Subtrait: Subtrait.Anxiety, positiveQuestion: true)],
    
    //Self Constiouness COMPLETE
        ...
        Question(content: "I am afraid to draw attention to myself", trait: Trait.Neuroticism, Subtrait: Subtrait.Self_Consciouness, positiveQuestion: false),
         Question(content: "I don't mind if life lacks direction", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Consciouness, positiveQuestion: false),
    ...
    //Immoderation COMPLETE
        ...
        Question(content: "I rearely overindulge", trait: Trait.Neuroticism, Subtrait: Subtrait.Immoderation, positiveQuestion: true),
         Question(content: "I act wild and crazy", trait: Trait.Neuroticism, Subtrait: Subtrait.Immoderation, positiveQuestion: true),
         Question(content: "I do crazy things", trait: Trait.Neuroticism, Subtrait: Subtrait.Immoderation, positiveQuestion: true),
    ...
    //Artistic Interests COMPLETE
        ...
        Question(content: "I enjoy watching dance performances", trait: Trait.Openess, Subtrait: Subtrait.Artistic_Interests, positiveQuestion: true),
         Question(content: "I enjoy visiting historical monuments", trait: Trait.Openess, Subtrait: Subtrait.Artistic_Interests, positiveQuestion: true),
        Question(content: "I love nature", trait: Trait.Openess, Subtrait: Subtrait.Artistic_Interests, positiveQuestion: true)],
    //Adventurousness COMPLETE
    ...
    //Imagination COMPLETE
        ...
        Question(content: "I enjoy examining myself and my life", trait: Trait.Conscientiousness, Subtrait: Subtrait.Self_Efficacy, positiveQuestion: true)],
    //Intelect -> COMPLETE
    ...
    //Emotionality COMPLETE
        ...
        Question(content: "I missjudge situations", trait: Trait.Openess, Subtrait: Subtrait.Emotionality, positiveQuestion: true),
        Question(content: "I set high standards for myself and others", trait: Trait.Openess, Subtrait: Subtrait.Emotionality, positiveQuestion: true)],
    //Liberalism COMPLETE
